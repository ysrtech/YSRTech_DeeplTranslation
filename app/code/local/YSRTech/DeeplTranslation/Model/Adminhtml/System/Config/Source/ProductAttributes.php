<?php
class YSRTech_DeeplTranslation_Model_Adminhtml_System_Config_Source_ProductAttributes
{
    /**
     * Returns all text and textarea product attributes as an option array.
     *
     * @return array
     */
